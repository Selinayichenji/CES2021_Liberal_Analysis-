...
\text{logit}(\pi_i) &= \beta_0 + \alpha_{g[i]}^{\text{age}}+ \alpha_{g[i]}^{\text{gender}} + \alpha_{s[i]}^{\text{education level}} 
+\alpha_{s[i]}^{\text{family income}} + \alpha_{s[i]}^{\text{children number}} + \alpha_{s[i]}^{\text{state}} \\
\beta_0 &\sim \text{Normal}(0, 2.5) \\
\alpha_{g}^{\text{age}} &\sim \text{Normal}(0, 2.5) \text{ for } g = 1,2,3,4,5 \\
\alpha_{g}^{\text{gender}} &\sim \text{Normal}(0, 2.5) \text{ for } g = 1,2 \\
\alpha_{g}^{\text{education level}} &\sim \text{Normal}(0, 2.5) \text{ for } g = 1,2,3,4,5,6 \\
\alpha_{g}^{\text{family income}} &\sim \text{Normal}(0, 2.5) \text{ for } g = 1,2,3,4,5,6 \\
\alpha_{g}^{\text{children number}} &\sim \text{Normal}(0, 2.5) \text{ for } g = 1,2,...,6 \\
